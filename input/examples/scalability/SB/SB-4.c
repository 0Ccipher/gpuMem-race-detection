...
__VERIFIER_memory_scope_device();
  ...
  int v16 = (v2_r1==0);
  atomic_store_explicit(&atom_0_r1_0_eq, v16, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v18 = (v6_r3==0);
  atomic_store_explicit(&atom_2_r3_0_eq, v18, memory_order_release);
  return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(&atom_0_r1_0_eq, memory_order_acquire);
  int v10 = atomic_load_explicit(&atom_1_r2_0_eq, memory_order_acquire);
  int v11 = atomic_load_explicit(&atom_2_r3_0_eq, memory_order_acquire);
