...
pthread_barrier_t bar_cta_sync_r3_dvwg_0_0; 
...
__VERIFIER_memory_scope_work_group();
  int v4= pthread_barrier_wait(&bar_cta_sync_r3_dvwg_0_0);
...
if (pthread_barrier_init(&bar_cta_sync_r2_dvwg_0_0, NULL, 2)) {
            printf("Could not create a barrier\n");
            return -1;
        }
if (pthread_barrier_init(&bar_cta_sync_r3_dvwg_0_0, NULL, 2)) {
            printf("Could not create a barrier\n");
            return -1;
        }
