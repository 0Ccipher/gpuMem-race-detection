...
__VERIFIER_weak_access();
  atomic_store_explicit(&vars[0], 42, memory_order_relaxed);
...
__VERIFIER_memory_scope_device();
  ...
  int v12 = (v2_r0==1);
  atomic_store_explicit(&atom_1_r0_1_eq, v12, memory_order_release);
  return NULL;
}
...
__VERIFIER_weak_access();
  ...
  int v13 = (v4_r1==1);
  atomic_store_explicit(&atom_2_r1_1_eq, v13, memory_order_release);
  int v14 = (v6_r2==42);
  atomic_store_explicit(&atom_2_r2_42_eq, v14, memory_order_release);
  return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v8 = atomic_load_explicit(&atom_2_r1_1_eq, memory_order_acquire);
  int v9 = atomic_load_explicit(&atom_2_r2_42_eq, memory_order_acquire);
  int v10_conj = v8 & v9;
