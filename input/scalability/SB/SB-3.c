...
__VERIFIER_memory_scope_device();
  ...
  int v12 = (v2_r1==0);
  atomic_store_explicit(&atom_0_r1_0_eq, v12, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v13 = (v4_r2==0);
  atomic_store_explicit(&atom_1_r2_0_eq, v13, memory_order_release);
  return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v7 = atomic_load_explicit(&atom_0_r1_0_eq, memory_order_acquire);
