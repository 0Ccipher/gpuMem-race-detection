...
__VERIFIER_memory_scope_device();
  ...
  int v44 = (v2_r1==1);
  atomic_store_explicit(&atom_0_r1_1_eq, v44, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v45 = (v4_r2==1);
  atomic_store_explicit(&atom_1_r2_1_eq, v45, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v46 = (v6_r3==1);
  atomic_store_explicit(&atom_2_r3_1_eq, v46, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v47 = (v8_r4==1);
  atomic_store_explicit(&atom_3_r4_1_eq, v47, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v48 = (v10_r5==1);
  atomic_store_explicit(&atom_4_r5_1_eq, v48, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v49 = (v12_r6==1);
  atomic_store_explicit(&atom_5_r6_1_eq, v49, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v50 = (v14_r7==1);
  atomic_store_explicit(&atom_6_r7_1_eq, v50, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v51 = (v16_r8==1);
  atomic_store_explicit(&atom_7_r8_1_eq, v51, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v52 = (v18_r9==1);
  atomic_store_explicit(&atom_8_r9_1_eq, v52, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v53 = (v20_r10==1);
  atomic_store_explicit(&atom_9_r10_1_eq, v53, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v54 = (v22_r0==1);
  atomic_store_explicit(&atom_10_r0_1_eq, v54, memory_order_release);
  return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v23 = atomic_load_explicit(&atom_0_r1_1_eq, memory_order_acquire);
  int v24 = atomic_load_explicit(&atom_1_r2_1_eq, memory_order_acquire);
  int v25 = atomic_load_explicit(&atom_2_r3_1_eq, memory_order_acquire);
  int v26 = atomic_load_explicit(&atom_3_r4_1_eq, memory_order_acquire);
  int v27 = atomic_load_explicit(&atom_4_r5_1_eq, memory_order_acquire);
  int v28 = atomic_load_explicit(&atom_5_r6_1_eq, memory_order_acquire);
  int v29 = atomic_load_explicit(&atom_6_r7_1_eq, memory_order_acquire);
  int v30 = atomic_load_explicit(&atom_7_r8_1_eq, memory_order_acquire);
  int v31 = atomic_load_explicit(&atom_8_r9_1_eq, memory_order_acquire);
  int v32 = atomic_load_explicit(&atom_9_r10_1_eq, memory_order_acquire);
  int v33 = atomic_load_explicit(&atom_10_r0_1_eq, memory_order_acquire);
