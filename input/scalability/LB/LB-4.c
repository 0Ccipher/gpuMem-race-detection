...
__VERIFIER_memory_scope_device();
  ...
  int v16 = (v2_r1==1);
  atomic_store_explicit(&atom_0_r1_1_eq, v16, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v17 = (v4_r2==1);
  atomic_store_explicit(&atom_1_r2_1_eq, v17, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v18 = (v6_r3==1);
  atomic_store_explicit(&atom_2_r3_1_eq, v18, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v19 = (v8_r0==1);
  atomic_store_explicit(&atom_3_r0_1_eq, v19, memory_order_release);
  return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v9 = atomic_load_explicit(&atom_0_r1_1_eq, memory_order_acquire);
  int v10 = atomic_load_explicit(&atom_1_r2_1_eq, memory_order_acquire);
  int v11 = atomic_load_explicit(&atom_2_r3_1_eq, memory_order_acquire);
  int v12 = atomic_load_explicit(&atom_3_r0_1_eq, memory_order_acquire);
