...
__VERIFIER_weak_access();
  ...
  int v11 = (v2_r0==2);
  atomic_store_explicit(&atom_1_r0_2_eq, v11, memory_order_release);
  return NULL;
}
...
__VERIFIER_weak_access();
  atomic_store_explicit(&vars[1], 1, memory_order_relaxed);
  int v12 = (v4_r0==1);
  atomic_store_explicit(&atom_2_r0_1_eq, v12, memory_order_release);
  return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v6 = (v5==2);
  int v7 = atomic_load_explicit(&atom_1_r0_2_eq, memory_order_acquire);
