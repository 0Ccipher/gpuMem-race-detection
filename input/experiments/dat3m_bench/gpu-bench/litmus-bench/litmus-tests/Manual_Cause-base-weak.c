...
__VERIFIER_memory_scope_system();
__VERIFIER_weak_access();
  int v8_r4 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  int v17 = (v4_r2==1);
  ...
  int v19 = (v8_r4==2);
  atomic_store_explicit(&atom_2_r4_2_eq, v19, memory_order_release);
  return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v12 = atomic_load_explicit(&atom_2_r4_2_eq, memory_order_acquire);
