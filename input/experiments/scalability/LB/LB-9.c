...
__VERIFIER_memory_scope_device();
  ...
  int v36 = (v2_r1==1);
  atomic_store_explicit(&atom_0_r1_1_eq, v36, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v37 = (v4_r2==1);
  atomic_store_explicit(&atom_1_r2_1_eq, v37, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v38 = (v6_r3==1);
  atomic_store_explicit(&atom_2_r3_1_eq, v38, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v39 = (v8_r4==1);
  atomic_store_explicit(&atom_3_r4_1_eq, v39, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v40 = (v10_r5==1);
  atomic_store_explicit(&atom_4_r5_1_eq, v40, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v41 = (v12_r6==1);
  atomic_store_explicit(&atom_5_r6_1_eq, v41, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v42 = (v14_r7==1);
  atomic_store_explicit(&atom_6_r7_1_eq, v42, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v43 = (v16_r8==1);
  atomic_store_explicit(&atom_7_r8_1_eq, v43, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v44 = (v18_r0==1);
  atomic_store_explicit(&atom_8_r0_1_eq, v44, memory_order_release);
  return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v19 = atomic_load_explicit(&atom_0_r1_1_eq, memory_order_acquire);
  int v20 = atomic_load_explicit(&atom_1_r2_1_eq, memory_order_acquire);
  int v21 = atomic_load_explicit(&atom_2_r3_1_eq, memory_order_acquire);
  int v22 = atomic_load_explicit(&atom_3_r4_1_eq, memory_order_acquire);
  int v23 = atomic_load_explicit(&atom_4_r5_1_eq, memory_order_acquire);
  int v24 = atomic_load_explicit(&atom_5_r6_1_eq, memory_order_acquire);
  int v25 = atomic_load_explicit(&atom_6_r7_1_eq, memory_order_acquire);
  int v26 = atomic_load_explicit(&atom_7_r8_1_eq, memory_order_acquire);
  int v27 = atomic_load_explicit(&atom_8_r0_1_eq, memory_order_acquire);
