...
long rd[3];;
atomic_int *data_ptr;
atomic_int *recovered_ptr;
data_ptr = &data;
rd[2] = (uintptr_t)data_ptr;;
rd[1] = (uintptr_t)rd[2];;
r[1] = group_id;;
p[1] = (r[1] == 0);;
if (p[1]) goto L__BB0_2;;
recovered_ptr=(atomic_int *)rd[1];
__VERIFIER_memory_scope_work_group();
r[2] = atomic_exchange(recovered_ptr, 2);;
goto L__BB0_3;;
L__BB0_2:;
recovered_ptr=(atomic_int *)rd[1];
__VERIFIER_memory_scope_work_group();
r[3] = atomic_exchange(recovered_ptr, 1);;
L__BB0_3:;
