...
__VERIFIER_weak_access();
  ...
  int v19 = (v2_r0==1);
  atomic_store_explicit(&atom_1_r0_1_eq, v19, memory_order_release);
  int v20 = (v4_r2==0);
  atomic_store_explicit(&atom_1_r2_0_eq, v20, memory_order_release);
  return NULL;
}
...
__VERIFIER_weak_access();
  ...
  int v21 = (v6_r0==2);
  atomic_store_explicit(&atom_3_r0_2_eq, v21, memory_order_release);
  int v22 = (v8_r2==2);
  atomic_store_explicit(&atom_3_r2_2_eq, v22, memory_order_release);
  return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(&atom_3_r0_2_eq, memory_order_acquire);
  int v12 = atomic_load_explicit(&atom_3_r2_2_eq, memory_order_acquire);
