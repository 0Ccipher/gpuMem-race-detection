...
__VERIFIER_memory_scope_device();
  ...
  int v52 = (v2_r1==1);
  atomic_store_explicit(&atom_1_r1_1_eq, v52, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v53 = (v4_r2==1);
  atomic_store_explicit(&atom_2_r2_1_eq, v53, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v54 = (v6_r3==1);
  atomic_store_explicit(&atom_3_r3_1_eq, v54, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v55 = (v8_r4==1);
  atomic_store_explicit(&atom_4_r4_1_eq, v55, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v56 = (v10_r5==1);
  atomic_store_explicit(&atom_5_r5_1_eq, v56, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v57 = (v12_r6==1);
  atomic_store_explicit(&atom_6_r6_1_eq, v57, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v58 = (v14_r7==1);
  atomic_store_explicit(&atom_7_r7_1_eq, v58, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v59 = (v16_r8==1);
  atomic_store_explicit(&atom_8_r8_1_eq, v59, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v60 = (v18_r9==1);
  atomic_store_explicit(&atom_9_r9_1_eq, v60, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v61 = (v20_r10==1);
  atomic_store_explicit(&atom_10_r10_1_eq, v61, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v62 = (v22_r11==1);
  atomic_store_explicit(&atom_11_r11_1_eq, v62, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_system();
__VERIFIER_weak_access();
  int v26_r0 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  int v63 = (v24_r12==1);
  atomic_store_explicit(&atom_12_r12_1_eq, v63, memory_order_release);
  int v64 = (v26_r0==0);
...
int main(int argc, char **argv){
  ...
  int v27 = atomic_load_explicit(&atom_1_r1_1_eq, memory_order_acquire);
  int v28 = atomic_load_explicit(&atom_2_r2_1_eq, memory_order_acquire);
  int v29 = atomic_load_explicit(&atom_3_r3_1_eq, memory_order_acquire);
  int v30 = atomic_load_explicit(&atom_4_r4_1_eq, memory_order_acquire);
  int v31 = atomic_load_explicit(&atom_5_r5_1_eq, memory_order_acquire);
  int v32 = atomic_load_explicit(&atom_6_r6_1_eq, memory_order_acquire);
  int v33 = atomic_load_explicit(&atom_7_r7_1_eq, memory_order_acquire);
  int v34 = atomic_load_explicit(&atom_8_r8_1_eq, memory_order_acquire);
  int v35 = atomic_load_explicit(&atom_9_r9_1_eq, memory_order_acquire);
  int v36 = atomic_load_explicit(&atom_10_r10_1_eq, memory_order_acquire);
  int v37 = atomic_load_explicit(&atom_11_r11_1_eq, memory_order_acquire);
  int v38 = atomic_load_explicit(&atom_12_r12_1_eq, memory_order_acquire);
