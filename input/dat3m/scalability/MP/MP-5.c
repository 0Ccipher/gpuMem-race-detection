...
__VERIFIER_memory_scope_device();
  ...
  int v20 = (v2_r1==1);
  atomic_store_explicit(&atom_1_r1_1_eq, v20, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v21 = (v4_r2==1);
  atomic_store_explicit(&atom_2_r2_1_eq, v21, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v22 = (v6_r3==1);
  atomic_store_explicit(&atom_3_r3_1_eq, v22, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_system();
__VERIFIER_weak_access();
  int v10_r0 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  int v23 = (v8_r4==1);
  atomic_store_explicit(&atom_4_r4_1_eq, v23, memory_order_release);
  int v24 = (v10_r0==0);
  atomic_store_explicit(&atom_4_r0_0_eq, v24, memory_order_release);
  return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(&atom_1_r1_1_eq, memory_order_acquire);
  int v12 = atomic_load_explicit(&atom_2_r2_1_eq, memory_order_acquire);
  int v13 = atomic_load_explicit(&atom_3_r3_1_eq, memory_order_acquire);
  int v14 = atomic_load_explicit(&atom_4_r4_1_eq, memory_order_acquire);
