...
__VERIFIER_memory_scope_device();
  ...
  int v24 = (v2_r1==1);
  atomic_store_explicit(&atom_1_r1_1_eq, v24, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v25 = (v4_r2==1);
  atomic_store_explicit(&atom_2_r2_1_eq, v25, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v26 = (v6_r3==1);
  atomic_store_explicit(&atom_3_r3_1_eq, v26, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v27 = (v8_r4==1);
  atomic_store_explicit(&atom_4_r4_1_eq, v27, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_system();
__VERIFIER_weak_access();
  int v12_r0 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  int v28 = (v10_r5==1);
  atomic_store_explicit(&atom_5_r5_1_eq, v28, memory_order_release);
  int v29 = (v12_r0==0);
  atomic_store_explicit(&atom_5_r0_0_eq, v29, memory_order_release);
  return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(&atom_1_r1_1_eq, memory_order_acquire);
  int v14 = atomic_load_explicit(&atom_2_r2_1_eq, memory_order_acquire);
  int v15 = atomic_load_explicit(&atom_3_r3_1_eq, memory_order_acquire);
  int v16 = atomic_load_explicit(&atom_4_r4_1_eq, memory_order_acquire);
  int v17 = atomic_load_explicit(&atom_5_r5_1_eq, memory_order_acquire);
  int v18 = atomic_load_explicit(&atom_5_r0_0_eq, memory_order_acquire);
