...
__VERIFIER_memory_scope_device();
  ...
  int v17 = (v4_r1==0);
  atomic_store_explicit(&atom_2_r1_0_eq, v17, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v18 = (v8_r0==0);
  atomic_store_explicit(&atom_3_r0_0_eq, v18, memory_order_release);
  int v19 = (v6_r1==1);
  atomic_store_explicit(&atom_3_r1_1_eq, v19, memory_order_release);
  return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v10 = atomic_load_explicit(&atom_2_r1_0_eq, memory_order_acquire);
  int v11 = atomic_load_explicit(&atom_3_r0_0_eq, memory_order_acquire);
  int v12 = atomic_load_explicit(&atom_3_r1_1_eq, memory_order_acquire);
