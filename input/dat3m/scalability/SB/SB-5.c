...
__VERIFIER_memory_scope_device();
  ...
  int v20 = (v2_r1==0);
  atomic_store_explicit(&atom_0_r1_0_eq, v20, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v21 = (v4_r2==0);
  atomic_store_explicit(&atom_1_r2_0_eq, v21, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v22 = (v6_r3==0);
  atomic_store_explicit(&atom_2_r3_0_eq, v22, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v23 = (v8_r4==0);
  atomic_store_explicit(&atom_3_r4_0_eq, v23, memory_order_release);
  return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v11 = atomic_load_explicit(&atom_0_r1_0_eq, memory_order_acquire);
  int v12 = atomic_load_explicit(&atom_1_r2_0_eq, memory_order_acquire);
  int v13 = atomic_load_explicit(&atom_2_r3_0_eq, memory_order_acquire);
  int v14 = atomic_load_explicit(&atom_3_r4_0_eq, memory_order_acquire);
