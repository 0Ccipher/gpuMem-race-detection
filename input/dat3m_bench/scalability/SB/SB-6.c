...
__VERIFIER_memory_scope_device();
  ...
  int v24 = (v2_r1==0);
  atomic_store_explicit(&atom_0_r1_0_eq, v24, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v25 = (v4_r2==0);
  atomic_store_explicit(&atom_1_r2_0_eq, v25, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v26 = (v6_r3==0);
  atomic_store_explicit(&atom_2_r3_0_eq, v26, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v27 = (v8_r4==0);
  atomic_store_explicit(&atom_3_r4_0_eq, v27, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v28 = (v10_r5==0);
  atomic_store_explicit(&atom_4_r5_0_eq, v28, memory_order_release);
  return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v13 = atomic_load_explicit(&atom_0_r1_0_eq, memory_order_acquire);
  int v14 = atomic_load_explicit(&atom_1_r2_0_eq, memory_order_acquire);
  int v15 = atomic_load_explicit(&atom_2_r3_0_eq, memory_order_acquire);
  int v16 = atomic_load_explicit(&atom_3_r4_0_eq, memory_order_acquire);
  int v17 = atomic_load_explicit(&atom_4_r5_0_eq, memory_order_acquire);
