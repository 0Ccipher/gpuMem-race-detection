...
__VERIFIER_memory_scope_device();
  ...
  int v28 = (v2_r1==1);
  atomic_store_explicit(&atom_1_r1_1_eq, v28, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v29 = (v4_r2==1);
  atomic_store_explicit(&atom_2_r2_1_eq, v29, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v30 = (v6_r3==1);
  atomic_store_explicit(&atom_3_r3_1_eq, v30, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v31 = (v8_r4==1);
  atomic_store_explicit(&atom_4_r4_1_eq, v31, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_device();
  ...
  int v32 = (v10_r5==1);
  atomic_store_explicit(&atom_5_r5_1_eq, v32, memory_order_release);
  return NULL;
}
...
__VERIFIER_memory_scope_system();
__VERIFIER_weak_access();
  int v14_r0 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  int v33 = (v12_r6==1);
  atomic_store_explicit(&atom_6_r6_1_eq, v33, memory_order_release);
  int v34 = (v14_r0==0);
...
int main(int argc, char **argv){
  ...
  int v15 = atomic_load_explicit(&atom_1_r1_1_eq, memory_order_acquire);
  int v16 = atomic_load_explicit(&atom_2_r2_1_eq, memory_order_acquire);
  int v17 = atomic_load_explicit(&atom_3_r3_1_eq, memory_order_acquire);
  int v18 = atomic_load_explicit(&atom_4_r4_1_eq, memory_order_acquire);
  int v19 = atomic_load_explicit(&atom_5_r5_1_eq, memory_order_acquire);
  int v20 = atomic_load_explicit(&atom_6_r6_1_eq, memory_order_acquire);
