...
__VERIFIER_weak_access();
  ...
  int v13 = (v4_r0==1);
  atomic_store_explicit(&atom_2_r0_1_eq, v13, memory_order_release);
  int v14 = (v6_r2==0);
  atomic_store_explicit(&atom_2_r2_0_eq, v14, memory_order_release);
  return NULL;
}
...
int main(int argc, char **argv){
  ...
  int v8 = atomic_load_explicit(&atom_2_r0_1_eq, memory_order_acquire);
  int v9 = atomic_load_explicit(&atom_2_r2_0_eq, memory_order_acquire);
  int v10_conj = v8 & v9;
