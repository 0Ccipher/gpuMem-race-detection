...
__VERIFIER_memory_scope_work_group();
  ...
  int v8 = (v2_r0==0);
  atomic_store_explicit(&atom_0_r0_0_eq, v8, memory_order_release);
  return NULL;
}
...
label_2:;
  ...
  __VERIFIER_thread_kernel_id(0);
__VERIFIER_memory_scope_work_group();
  int v5= pthread_barrier_wait(&bar_cta_sync_0_dvwg_0_0);
...
if (pthread_barrier_init(&bar_cta_sync_1_dvwg_0_0, NULL, 2)) {
  ...
  int v7 = atomic_load_explicit(&atom_0_r0_0_eq, memory_order_acquire);
  if (v7 == 1) assert(0);
  return 0;
}
