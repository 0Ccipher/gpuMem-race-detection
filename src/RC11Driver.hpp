...
private:
	...
	View calcWriteMsgViewScoped(const WriteLabel *lab, const Event acq , int scope, int group , int kernel);
	...
	void calcFenceRelRfPoBefore(Event last, View &v, Event acq, int scope, int group , int kernel);
